...
*
* Filename: main.c
* Description: The main.c file for lab7
* Author: Jarod England jkenglan with Joel Park jgpark
* Maintainer:Jarod England jkenglan with Joel Park jgpark
* Created: In class oct14th
/* Code: */
